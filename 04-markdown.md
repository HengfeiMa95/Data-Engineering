...
第一个是`Xaringan`模板`NHSRthemes`，这个模板的设计是非常简洁美观的，感兴趣取得可以通过安装其拓展包学习，<https://spcanelon.github.io/xaringan-basics-and-beyond/nhsr-theme/sample-16-9.html#1>
...
值得注意的是，learnr的不同代码块之间是独立的运行环境，是不联通的。这就导致在同一个文档中需要反复读入数据，如果要服复用某个代码块的环境，可以通过exercise.setup指定已运行的环境。
